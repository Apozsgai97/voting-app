...
export async function RepresentativeByIdPage({ elections, id }: Props) {
  ...
  const representativeData = await representativeFeature.service.getPublicUserChoiceAndRepresentative(id)
  ...
  return (
    <main className="flex flex-col justify-center items-center p-0">
      ...
      <Buttons representativeId={id} publicUserRepId={representativeData.publicUserRepId} />
